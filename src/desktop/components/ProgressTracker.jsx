...
export default function ProgressTracker() {
  ...
  return (
    <section
      className="bg-[url('./assets/images/bg-sidebar-desktop.svg')] min-w-[272px] 
    h-full flex pt-10 pl-[30px] bg-no-repeat bg-cover bg-center rounded-xl"
    >
      <div className="w-46 h-8 flex flex-col gap-[32px] justify-between">
        {[1, 2, 3, 4].map((step) => (
          <div className="flex gap-4">
            <div
              key={step}
              className={`w-8 h-8 leading-[30px] p-0 border-1 border-solid flex justify-center 
            ...
            <div className="flex flex-col gap-[2px] leading-none">
              <p className="font-light opacity-75 tracking-tight text-sm text-magnolia leading-none">{`STEP ${step}`}</p>
